...
public class MudurLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("MÜDÜR GİRİS EKRANI");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bankmanager.setTc(username);
        bankmanager.setPassword(password);
        bankmanager.selectLogin(bankmanager.getTc(), bankmanager.getPassword());  
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MudurLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MudurLogin().setVisible(true);
            }
        });
    }
